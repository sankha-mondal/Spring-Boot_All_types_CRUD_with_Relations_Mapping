...
public class Passenger {    //  Passenger = Login-Credentials
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY)    // One Passenger has many Bookings
	@JoinColumn(name = "p_Email")     //  "p_Email" column will be created in "Booking" Table
